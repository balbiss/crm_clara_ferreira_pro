> ⚠️ **Documento herdado da base VisitaIA (copiado em 2026-07-14), ainda não reescrito pro CRM Clara Ferreira.**
> Descreve o sistema original de imobiliária, não o de revenda consignada. Ver `CLAUDE.md` pro estado atual e o plano de adaptação. Reescrever isso faz parte de uma fase futura, não crítico agora.
